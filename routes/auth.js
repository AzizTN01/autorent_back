...
router.put('/update-profile', authenticateToken, upload.profilePicture, authController.updateProfile);
...
router.post('/companies/:companyId/cars', authenticateToken, upload.carImage, carController.addCarToCompany);
